...
class TrackedBall(_message.Message):
    ...
    visibility: float
    def __init__(self, pos: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector3, _Mapping]] = ..., vel: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector3, _Mapping]] = ..., visibility: _Optional[float] = ...) -> None: ...
...
class KickedBall(_message.Message):
    ...
    stop_pos: _ssl_game_controller_geometry_pb2.Vector2
    robot_id: _ssl_game_controller_common_pb2.BotId
    def __init__(self, pos: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., vel: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector3, _Mapping]] = ..., start_timestamp: _Optional[float] = ..., stop_timestamp: _Optional[float] = ..., stop_pos: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., robot_id: _Optional[_Union[_ssl_game_controller_common_pb2.BotId, _Mapping]] = ...) -> None: ...
...
class TrackedRobot(_message.Message):
    ...
    pos: _ssl_game_controller_geometry_pb2.Vector2
    orientation: float
    vel: _ssl_game_controller_geometry_pb2.Vector2
    vel_angular: float
    visibility: float
    def __init__(self, robot_id: _Optional[_Union[_ssl_game_controller_common_pb2.BotId, _Mapping]] = ..., pos: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., orientation: _Optional[float] = ..., vel: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., vel_angular: _Optional[float] = ..., visibility: _Optional[float] = ...) -> None: ...
