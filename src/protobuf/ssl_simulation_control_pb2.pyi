...
import protobuf.ssl_simulation_config_pb2 as _ssl_simulation_config_pb2
import protobuf.ssl_simulation_error_pb2 as _ssl_simulation_error_pb2
...
class TeleportRobot(_message.Message):
    ...
    present: bool
    by_force: bool
    def __init__(self, id: _Optional[_Union[_ssl_game_controller_common_pb2.BotId, _Mapping]] = ..., x: _Optional[float] = ..., y: _Optional[float] = ..., orientation: _Optional[float] = ..., v_x: _Optional[float] = ..., v_y: _Optional[float] = ..., v_angular: _Optional[float] = ..., present: bool = ..., by_force: bool = ...) -> None: ...
...
class SimulatorCommand(_message.Message):
    ...
    config: _ssl_simulation_config_pb2.SimulatorConfig
    def __init__(self, control: _Optional[_Union[SimulatorControl, _Mapping]] = ..., config: _Optional[_Union[_ssl_simulation_config_pb2.SimulatorConfig, _Mapping]] = ...) -> None: ...

class SimulatorResponse(_message.Message):
    __slots__ = ("errors",)
    ERRORS_FIELD_NUMBER: _ClassVar[int]
    errors: _containers.RepeatedCompositeFieldContainer[_ssl_simulation_error_pb2.SimulatorError]
    def __init__(self, errors: _Optional[_Iterable[_Union[_ssl_simulation_error_pb2.SimulatorError, _Mapping]]] = ...) -> None: ...
