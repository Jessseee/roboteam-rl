...
class RealismConfigErForce(_message.Message):
    __slots__ = ("stddev_ball_p", "stddev_robot_p", "stddev_robot_phi", "stddev_ball_area", "enable_invisible_ball", "ball_visibility_threshold", "camera_overlap", "dribbler_ball_detections", "camera_position_error", "robot_command_loss", "robot_response_loss", "missing_ball_detections", "vision_delay", "vision_processing_time", "simulate_dribbling", "object_position_offset", "missing_robot_detections")
    ...
    OBJECT_POSITION_OFFSET_FIELD_NUMBER: _ClassVar[int]
    MISSING_ROBOT_DETECTIONS_FIELD_NUMBER: _ClassVar[int]
    stddev_ball_p: float
