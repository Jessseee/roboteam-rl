...
class RobotSpecs(_message.Message):
    ...
    def __init__(self, id: _Optional[_Union[_ssl_game_controller_common_pb2.BotId, _Mapping]] = ..., radius: _Optional[float] = ..., height: _Optional[float] = ..., mass: _Optional[float] = ..., max_linear_kick_speed: _Optional[float] = ..., max_chip_kick_speed: _Optional[float] = ..., center_to_dribbler: _Optional[float] = ..., limits: _Optional[_Union[RobotLimits, _Mapping]] = ..., wheel_angles: _Optional[_Union[RobotWheelAngles, _Mapping]] = ..., custom: _Optional[_Iterable[_Union[_any_pb2.Any, _Mapping]]] = ...) -> None: ...
...
class SimulatorConfig(_message.Message):
    ...
    vision_port: int
    def __init__(self, geometry: _Optional[_Union[_ssl_geometry_pb2.SSL_GeometryData, _Mapping]] = ..., robot_specs: _Optional[_Iterable[_Union[RobotSpecs, _Mapping]]] = ..., realism_config: _Optional[_Union[RealismConfig, _Mapping]] = ..., vision_port: _Optional[int] = ...) -> None: ...
