...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SSL_REFEREE_TEAMINFO'].fields_by_name['yellow_card_times']._options = None
  _globals['_SSL_REFEREE_TEAMINFO'].fields_by_name['yellow_card_times']._serialized_options = b'\020\001'
  _globals['_SSL_REFEREE'].fields_by_name['gameEvent']._options = None
  _globals['_SSL_REFEREE'].fields_by_name['gameEvent']._serialized_options = b'\030\001'
  _globals['_SSL_REFEREE'].fields_by_name['game_events_old']._options = None
  _globals['_SSL_REFEREE'].fields_by_name['game_events_old']._serialized_options = b'\030\001'
  _globals['_SSL_REFEREE'].fields_by_name['proposed_game_events']._options = None
  _globals['_SSL_REFEREE'].fields_by_name['proposed_game_events']._serialized_options = b'\030\001'
  _globals['_SSL_REFEREE']._serialized_start=79
  _globals['_SSL_REFEREE']._serialized_end=1910
  _globals['_SSL_REFEREE_TEAMINFO']._serialized_start=800
  _globals['_SSL_REFEREE_TEAMINFO']._serialized_end=1146
  _globals['_SSL_REFEREE_POINT']._serialized_start=1148
  _globals['_SSL_REFEREE_POINT']._serialized_end=1177
  _globals['_SSL_REFEREE_STAGE']._serialized_start=1180
  _globals['_SSL_REFEREE_STAGE']._serialized_end=1517
  _globals['_SSL_REFEREE_COMMAND']._serialized_start=1520
  _globals['_SSL_REFEREE_COMMAND']._serialized_end=1910
  _globals['_PROPOSEDGAMEEVENT']._serialized_start=1912
  _globals['_PROPOSEDGAMEEVENT']._serialized_end=2020
  _globals['_GAMEEVENTPROPOSALGROUP']._serialized_start=2022
  _globals['_GAMEEVENTPROPOSALGROUP']._serialized_end=2111
