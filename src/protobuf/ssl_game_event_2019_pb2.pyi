...
class GameEvent(_message.Message):
    ...
    class BallLeftField(_message.Message):
        ...
        by_team: _ssl_game_controller_common_pb2.Team
        by_bot: int
        location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    class AimlessKick(_message.Message):
        ...
        by_bot: int
        location: _ssl_game_controller_geometry_pb2.Vector2
        kick_location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., kick_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    class Goal(_message.Message):
        ...
        by_team: _ssl_game_controller_common_pb2.Team
        kicking_team: _ssl_game_controller_common_pb2.Team
        kicking_bot: int
        location: _ssl_game_controller_geometry_pb2.Vector2
        kick_location: _ssl_game_controller_geometry_pb2.Vector2
        ...
        message: str
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., kicking_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., kicking_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., kick_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., max_ball_height: _Optional[float] = ..., num_robots_by_team: _Optional[int] = ..., last_touch_by_team: _Optional[int] = ..., message: _Optional[str] = ...) -> None: ...
    ...
    class ChippedGoal(_message.Message):
        ...
        kick_location: _ssl_game_controller_geometry_pb2.Vector2
        max_ball_height: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., kick_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., max_ball_height: _Optional[float] = ...) -> None: ...
    class BotTooFastInStop(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        speed: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., speed: _Optional[float] = ...) -> None: ...
    class DefenderTooCloseToKickPoint(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        distance: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., distance: _Optional[float] = ...) -> None: ...
    class BotCrashDrawn(_message.Message):
        ...
        speed_diff: float
        crash_angle: float
        def __init__(self, bot_yellow: _Optional[int] = ..., bot_blue: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., crash_speed: _Optional[float] = ..., speed_diff: _Optional[float] = ..., crash_angle: _Optional[float] = ...) -> None: ...
    class BotCrashUnique(_message.Message):
        ...
        speed_diff: float
        crash_angle: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., violator: _Optional[int] = ..., victim: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., crash_speed: _Optional[float] = ..., speed_diff: _Optional[float] = ..., crash_angle: _Optional[float] = ...) -> None: ...
    class BotPushedBot(_message.Message):
        ...
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., violator: _Optional[int] = ..., victim: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., pushed_distance: _Optional[float] = ...) -> None: ...
    class BotTippedOver(_message.Message):
        ...
        by_bot: int
        location: _ssl_game_controller_geometry_pb2.Vector2
        ball_location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., ball_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    ...
    class DefenderInDefenseAreaPartially(_message.Message):
        ...
        distance: float
        ball_location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., distance: _Optional[float] = ..., ball_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    ...
    class BotKickedBallTooFast(_message.Message):
        ...
        chipped: bool
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., initial_ball_speed: _Optional[float] = ..., chipped: bool = ...) -> None: ...
    class BotDribbledBallTooFar(_message.Message):
        ...
        by_team: _ssl_game_controller_common_pb2.Team
        by_bot: int
        start: _ssl_game_controller_geometry_pb2.Vector2
        end: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., start: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., end: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    class AttackerTouchedOpponentInDefenseArea(_message.Message):
        ...
        victim: int
        location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., victim: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    ...
    class BotHeldBallDeliberately(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        duration: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., by_bot: _Optional[int] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., duration: _Optional[float] = ...) -> None: ...
    ...
    class MultipleCards(_message.Message):
        ...
        BY_TEAM_FIELD_NUMBER: _ClassVar[int]
        by_team: _ssl_game_controller_common_pb2.Team
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ...) -> None: ...
    ...
    class KickTimeout(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        time: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., time: _Optional[float] = ...) -> None: ...
    class NoProgressInGame(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        time: float
        def __init__(self, location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., time: _Optional[float] = ...) -> None: ...
    class PlacementFailed(_message.Message):
        ...
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., remaining_distance: _Optional[float] = ...) -> None: ...
    class UnsportingBehaviorMinor(_message.Message):
        ...
        by_team: _ssl_game_controller_common_pb2.Team
        reason: str
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., reason: _Optional[str] = ...) -> None: ...
    ...
    class KeeperHeldBall(_message.Message):
        ...
        location: _ssl_game_controller_geometry_pb2.Vector2
        duration: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ..., duration: _Optional[float] = ...) -> None: ...
    class PlacementSucceeded(_message.Message):
        ...
        precision: float
        distance: float
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., time_taken: _Optional[float] = ..., precision: _Optional[float] = ..., distance: _Optional[float] = ...) -> None: ...
    ...
    class TooManyRobots(_message.Message):
        ...
        ball_location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., num_robots_allowed: _Optional[int] = ..., num_robots_on_field: _Optional[int] = ..., ball_location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
    class BoundaryCrossing(_message.Message):
        ...
        by_team: _ssl_game_controller_common_pb2.Team
        location: _ssl_game_controller_geometry_pb2.Vector2
        def __init__(self, by_team: _Optional[_Union[_ssl_game_controller_common_pb2.Team, str]] = ..., location: _Optional[_Union[_ssl_game_controller_geometry_pb2.Vector2, _Mapping]] = ...) -> None: ...
