...
class RobotControlResponse(_message.Message):
    ...
    def __init__(self, errors: _Optional[_Iterable[_Union[_ssl_simulation_error_pb2.SimulatorError, _Mapping]]] = ..., feedback: _Optional[_Iterable[_Union[RobotFeedback, _Mapping]]] = ...) -> None: ...
