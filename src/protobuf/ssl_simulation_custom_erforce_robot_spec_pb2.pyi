...
class RobotSpecErForce(_message.Message):
    __slots__ = ("shoot_radius", "dribbler_height", "dribbler_width")
    ...
    def __init__(self, shoot_radius: _Optional[float] = ..., dribbler_height: _Optional[float] = ..., dribbler_width: _Optional[float] = ...) -> None: ...
